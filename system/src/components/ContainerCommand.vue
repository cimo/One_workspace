    ...
    methods: {
                ...
                Sio.readMessage(`t_exec_o_${containerName}_status`, data => {
                    if (this.commandStatusList[containerName] < 0) {
                        ...
                        if (
                            ...
                            this.elementStatusList[containerName].innerHTML =
                                "Running...";
                    }
                });
            }
        ...
        init(windowComponent) {
            ...
            if (currentWindowElement !== null) {
                this.windowComponentList[
                    currentWindowElement.containerName
                ] = windowComponent;
                this.buttonCommandList[
                    currentWindowElement.containerName
                ] = this.windowComponentList[
                    currentWindowElement.containerName
                ].querySelectorAll(".command_component .right .cmd");
                this.elementStatusList[
                    currentWindowElement.containerName
                ] = this.windowComponentList[
                    currentWindowElement.containerName
                ].querySelector(".command_component .status");
        ...
        clickLogic(event) {
            ...
            if (currentWindowElement !== null) {
                ...
                if (event.target.classList.contains("cmd") === true) {
                    ...
                    Sio.readMessage(
                        `t_exec_o_${currentWindowElement.containerName}_command`,
                        data => {
        ...
        close(windowComponent) {
            ...
            if (
                ...
                Sio.stopRead(
                    `t_exec_o_${currentWindowElement.containerName}_status`
                );

                clearInterval(
                    this.intervalStatusList[currentWindowElement.containerName]
                );

                delete this.windowComponentList[
                    currentWindowElement.containerName
                ];
                delete this.buttonCommandList[
                    currentWindowElement.containerName
                ];
                delete this.intervalStatusList[
                    currentWindowElement.containerName
                ];
                delete this.elementStatusList[
                    currentWindowElement.containerName
                ];
                delete this.commandStatusList[
                    currentWindowElement.containerName
                ];
            }
        }
