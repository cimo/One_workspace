        ...
        init(windowComponent) {
            ...
            if (currentWindowElement !== null) {
                ...
                this.inputName = windowComponent.querySelector(
                    ".part_1_container input[name='name']"
                );
                this.inputServer = windowComponent.querySelector(
                    ".part_1_container input[name='server']"
                );
                ...
                this.inputKeyPublic = windowComponent.querySelector(
                    ".part_1_container input[name='key_public']"
                );
                            ...
                            for (const value of outSplit) {
                                if (
                                    ...
                                    option.text = value.replace(
                                        Config.setting.systemData.extensionSsh,
                                        ""
                                    );
                ...
                if (event.target.classList.contains("save") === true) {
                    ...
                    if (
                        ...
                        Sio.readMessage(
                            ...
                            data => {
                                ...
                                Sio.readMessage(
                                    "t_exec_stream_o_sshClickLogicSave",
                                    data => {
                                        if (data.chunk === "end") {
                                            Sio.stopRead(
                                                "t_exec_stream_o_sshClickLogicSave"
                    ...
                    if (this.selectEdit.selectedIndex > 0) {
                        this.$root.$refs.promptComponent.show(
                            windowComponent,
                            "You really want to delete this ssh?",
                            () => {
                                Sio.sendMessage("t_exec_i", {
            ...
            if (currentWindowElement !== null) {
                if (event.target.classList.contains("edit") === true) {
                    if (this.selectEdit.selectedIndex > 0) {
                        ...
                        Sio.readMessage(
                            "t_exec_stream_o_sshChangeLogicEdit",
                            data => {
