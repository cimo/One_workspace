...
export default {
    ...
    methods: {
        ...
        clickLogic(event) {
            ...
            if (menuElement !== null) {
                const windowComponent = Helper.findParent(menuElement, [
                    "window_component"
                ]);
                ...
                if (windowComponent !== null) {
                    ...
                    if (index >= 0) {
                        ...
                        if (index === 0) {
                            windowComponent.querySelector(
                                ".container_component .command_component"
                            ).style.display = "block";
                            windowComponent.querySelector(
                                ".container_component .terminal_container_component"
                            ).style.display = "none";
                            windowComponent.querySelector(
                                ".container_component .data_component"
                            ).style.display = "none";

                            this.$root.$refs.containerCommandComponent.init(
                                windowComponent
                            );
                        } else if (index === 1) {
                            windowComponent.querySelector(
                            ...
                            this.$root.$refs.containerTerminalComponent.init(
                                windowComponent
                            );
                        } else if (index === 2) {
                            windowComponent.querySelector(
                            ...
                            this.$root.$refs.containerDataComponent.init(
                                windowComponent
                            );
                        }
                    }
